    ...
    $estado='BLOQUEADO';
        ...
        if ($num_rows==0){ 
            ...
            echo '<script>Swal.fire({
                title: "¡ALGÓ SALIO MAL!",
                text: "SU PREGUNTA Y RESPUESTA NO COINCIDEN, SU USUARIO HA SIDO BLOQUEADO TEMPORALMENTE CONTACTA CON EL ADMINISTRADOR.",
                icon: "info",
                type: "info"
                }).then(function() {
