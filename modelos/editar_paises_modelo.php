...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>53,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA EDITAR NACIONALIDADES',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
  if(isset($_GET['id'])){
    $id=$_GET['id'];
    $sql="SELECT * FROM TBL_PAISES WHERE PAIS_CODIGO= :id";
  $resultado=$conexion->prepare($sql);	
    $resultado->execute(array(":id"=>$id));
   if ($resultado->rowCount()>=1) {
       $fila=$resultado->fetch();
       $id=$fila['PAIS_CODIGO'];
       $nombre=$fila['PAIS_NOMBRE'];
...
<?php require "../modelos/actualizar_paises_modelo.php"?>
