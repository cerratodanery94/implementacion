...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>59,":accion"=>'CONSULTAR',":descr"=>'GENERO REPORTE DINAMICO DE CITAS',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
