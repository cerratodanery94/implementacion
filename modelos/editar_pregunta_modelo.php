...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>48,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA EDITAR PREGUNTAS',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
  if(isset($_GET['id'])){
    $id=$_GET['id'];
    $sql="SELECT * FROM TBL_PREGUNTAS WHERE PRE_CODIGO= :id";
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                ...
                <span class="input-group-addon">Ingresar pregunta</span>
                  <input type="hidden" name="id" id="id" value="<?php echo $id?>">
                  <input type="hidden" autocomplete="off" style="text-transform:uppercase" class="form-control" placeholder=""  name="nombrea" id="nombrea" value="<?php echo $nombre?>" >
              ...
              <div class="col text-center">
                ...
                <button type="button" onclick=" validar_pregun();" class="btn btn-lg btn btn-primary"><i class="fa fa-refresh" aria-hidden="true"></i> ACTUALIZAR</button>
...
<?php require "../modelos/actualizar_pregunta_modelo.php"?>
