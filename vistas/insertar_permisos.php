...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>56,":accion"=>'INGRESO',":descr"=>'INGRESO A LA PANTALLA DE AÑADIR PERMISOS',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));         
?>
<!DOCTYPE html>
<html>
<head>
