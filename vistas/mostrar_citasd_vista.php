...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>41,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA DE MOSTRAR CITAS DEL DIA',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));         
$sql2="INSERT  INTO TBL_BITACORA (BIT_CODIGO,USU_CODIGO,OBJ_CODIGO,BIT_ACCION,BIT_DESCRIPCION,BIT_FECHA,BIT_HORA) 
VALUES (:id,:usuc,:objeto,:accion,:descr,:fecha,:hora )";
$resultado2=$conexion->prepare($sql2);	
    ...
    [        
      {
          ...
          //  orientation: 'landscape',
            ...
            {	              
                    ...
                    doc.styles.tableHeader.fontSize = 11;//tamaño de la tala ,cabeza
                    doc.styles.title = {
