...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>22,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA DE MOSTRAR EXPEDIENTES NUTRICIONISTA',":fecha"=>date("Y-m-d H:i:s")));         
$sql2="INSERT  INTO TBL_BITACORA (BIT_CODIGO,USU_CODIGO,OBJ_CODIGO,BIT_ACCION,BIT_DESCRIPCION,BIT_FECHA) 
VALUES (:id,:usuc,:objeto,:accion,:descr,:fecha)";
$resultado2=$conexion->prepare($sql2);	
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>22,":accion"=>'CONSULTA',":descr"=>'MUESTRA LA LISTA DE EXPEDIENTES NUTRICIONISTA',":fecha"=>date("Y-m-d H:i:s")));
