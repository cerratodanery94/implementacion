...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>49,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA DE MOSTRAR OBJETOS',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));         
$sql2="INSERT  INTO TBL_BITACORA (BIT_CODIGO,USU_CODIGO,OBJ_CODIGO,BIT_ACCION,BIT_DESCRIPCION,BIT_FECHA,BIT_HORA) 
VALUES (:id,:usuc,:objeto,:accion,:descr,:fecha,:hora)";
$resultado2=$conexion->prepare($sql2);	
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>49,":accion"=>'CONSULTA',":descr"=>'MUESTRA LA LISTA DE OBJETOS',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
  ...
  <div class="content-wrapper">
    ...
    <h1><i class="fa fa-list-alt" aria-hidden="true"></i>
      ...
      <li><a href="../vistas/index2.php"><i class="fa fa-home"></i>Panel de control</a></li>
        <li><a href="mostrar_pantallas.php"><i class="fa fa-television"></i>Pantallas</a></li>
        <li class="active"><i class="fa fa-list-alt"></i> Lista de pantallas</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               $consulta=$conexion->prepare("SELECT * from tbl_objetos");
               $consulta->execute();
                 while($fila=$consulta->fetch()){?>
                 <tr>
                 <td><?php echo $fila['OBJ_CODIGO']?></td>
                 <td><?php echo $fila['OBJ_NOMBRE']?></td>
                 <td><?php echo $fila['OBJ_DESCRIPCION']?></td>
                 <td><?php echo $fila['OBJ_TIPO']?></td>
