...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>5,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA DE CAMBIO DE CONTRASEÑA',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s"))); 
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action=" " method="POST" name="Form_cambiar">
...
<?php require"../modelos/cambiar_contra_modelo.php" ?>