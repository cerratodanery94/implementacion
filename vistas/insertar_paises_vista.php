...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>52,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA AÑADIR NACIONALIDAD',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
   ...
   <section class="content">
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
           <div>
        <form action="" method="POST" role="" name="form_pais">
        <div id="alerta1"></div>
...
<?php require "../modelos/insertar_paises_modelo.php" ?>
