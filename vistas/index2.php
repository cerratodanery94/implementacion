...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>38,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA PRINCIPAL ADMINISTRADOR',":fecha"=>date("Y-m-d H:i:s")));
