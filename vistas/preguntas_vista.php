...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>4,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA DE REGISTRAR PREGUNTAS',":fecha"=>date("Y-m-d H:m:s"),":hora"=>date("H:m:s")));            
?>
