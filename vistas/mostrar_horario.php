...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>54,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA DE MOSTRAR HORARIO',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));         
$sql2="INSERT  INTO TBL_BITACORA (BIT_CODIGO,USU_CODIGO,OBJ_CODIGO,BIT_ACCION,BIT_DESCRIPCION,BIT_FECHA,BIT_HORA) 
VALUES (:id,:usuc,:objeto,:accion,:descr,:fecha,:hora)";
$resultado2=$conexion->prepare($sql2);	
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>54,":accion"=>'CONSULTA',":descr"=>'MUESTRA LA LISTA DE HORARIOS',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
