...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>43,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA DE MOSTRAR PROFESIONES/OCUPACIONES',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));         
$sql2="INSERT  INTO TBL_BITACORA (BIT_CODIGO,USU_CODIGO,OBJ_CODIGO,BIT_ACCION,BIT_DESCRIPCION,BIT_FECHA,BIT_HORA) 
VALUES (:id,:usuc,:objeto,:accion,:descr,:fecha,:hora)";
$resultado2=$conexion->prepare($sql2);	
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>43,":accion"=>'CONSULTA',":descr"=>'MUESTRA LA LISTA DE PROFESIONES/OCUPACIONES',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
...
<head>
  ...
  <title>Mostrar Profesiones | Ocupaciones</title>
...
<header class="main-header">
  ...
  <div class="content-wrapper">
    ...
    <h1><i class="fa fa-list-alt" aria-hidden="true"></i>
        Lista de Profesiones | Ocupaciones
        <small>ClimeHome</small>
      </h1>
      <ol class="breadcrumb">
      <li><a href="../vistas/index2.php"><i class="fa fa-home"></i>Panel de control</a></li>
        <li><a href="mostrar_profesiones.php"><i class="fa fa-graduation-cap"></i>Profesiones | Ocupaciones</a></li>
        <li class="active"><i class="fa fa-list-alt"></i> Lista de Profesiones | Ocupaciones</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="box box-primary">
            ...
            <?php } ?>
              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               $consulta=$conexion->prepare("SELECT * from tbl_ocupaciones");
               $consulta->execute();
...
<script>
   $('.btne').on('click',function(e){
     ...
     Swal.fire({
  title: '¿ESTA SEGURO DE ELIMINAR PROFESION/OCUPACION?',
  ...
  if (result.value) {
   ...
   if (flashdata) {
    swal.fire({
       icon:'success',
       title:'ELIMINADO',
       text:'SE HA ELIMINADO PROFESION/OCUPACION'
     })
   }
</script>
<!-- page script -->
