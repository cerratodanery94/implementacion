...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_u"],":objeto"=>8,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA DE VERIFICAR PREGUNTAS',":fecha"=>date("Y-m-d"),":hora"=>date("H:m:s")));
?>
<!DOCTYPE html>
<html>
<head>
