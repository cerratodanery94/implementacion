...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>47,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA AÑADIR PREGUNTAS',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
...
<?php require "../modelos/insertar_preguntas_modelo.php" ?>
