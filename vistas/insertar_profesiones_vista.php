...
$resultado2->execute(array(":id"=>NULL,":usuc"=>$_SESSION["id_us"],":objeto"=>44,":accion"=>'INGRESO',":descr"=>'INGRESO ALA PANTALLA AÑADIR PROSEFIONES/OCUPACIONES',":fecha"=>date("Y-m-d"),":hora"=>date("H:i:s")));
...
<head>
  ...
  <title>Registrar  Profesión | Ocupación </title>
...
<header class="main-header">
  ...
  <div class="content-wrapper">
    ...
    <h1><i class="fa fa-tag" aria-hidden="true"></i>
      Registrar Profesión | Ocupación
        <small>ClimeHome</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../vistas/mostrar_profesiones.php"><i class="fa fa-graduation-cap"></i>Profesiones | Ocupaciones</a></li>
        <li class="active"><i class="fa fa-tag"></i> Registrar Profesiones | Ocupaciones</li>
      </ol>
    </section>
   <!-- Main content -->
